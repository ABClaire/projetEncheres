		...
		<div class="col-md-12">
			<div class="row">		
				...
				<div class="col-md-4">
					...
					<p id="pseudoEncheriste">Meilleure offre : 
					${model.article.enchereMaximum.montantEnchere} par ${model.encheriste.pseudo}${aucuneEnchere} </p>
					...
					<!-- noArticle envoyé dans la requête en "hidden" pour conserver l'information -->
						...
						<input type="number" name="proposition" min="${model.article.miseAPrix}" 
						value="${model.article.enchereMaximum.montantEnchere}"/>
